...
const Checkout = () => {
  ...
  const validateRequest = (items, addresses) => {
    ...
    let totalOrderValue = getTotalCartValue(items);

    let isMoneyNotThere = balance < totalOrderValue ? true : false;
    let noAddressesPresent = addresses.all.length === 0 ? true : false;
    console.log(noAddressesPresent);
    let noAddressSelected = addresses.selected.length === 0 ? true : false;
    ...
    if (isMoneyNotThere) {
      ...
      return false;
    } else if (noAddressesPresent) {
      enqueueSnackbar("Please add a new address before proceeding.", {
        variant: "warning",
      });
      return false;
    } else if (noAddressSelected) {
  ...
  const performCheckout = async (token, items, addresses) => {
    ...
    console.log("inside core functionality");
    try {
    ...
    <>
      ...
      <Grid container>
        <Grid item xs={12} md={9}>
          <Box className="shipping-container" minHeight="100vh">
                    ...
                    <>
                      {addresses.selected === e._id ? (
                        <a href="#" style={{ textDecoration: "none" }}>
                          ...
                          >
                            <Typography ml={2}>{e.address}</Typography>
                            <div
                              style={{
                                display: "flex",
                                flexDirection: "row",
                            ...
                            >
                              <Button
                                ...
                                onClick={(event) => {
                                  ...
                                  console.log("its in delete address");
                                  deleteAddress(token, e._id);
                                }}
                              >
                        ...
                        <div style={{ display:'flex',flexDirection:'row', justifyContent:'flex-start',position: "relative" }}>
                          <a
                            href="#"
                            style={{
                              textDecoration: "none",
            ...
            <Button
              ...
              variant="contained"
              onClick={() => {
                // performCheckout(token, items, addresses).then(x => console.log(x))
                // console.log(validateRequest(items,addresses))
        ...
        <Grid item xs={12} md={3} bgcolor="#E9F5E1">
          <Cart isReadOnly={true} products={products} items={allCartData} />
        </Grid>
      </Grid>
      <Footer />
    </>
